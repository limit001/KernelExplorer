...
#define IOCTL_TEST_001 \
    CTL_CODE( SIOCTL_TYPE, 0x904, METHOD_NEITHER , FILE_ANY_ACCESS  )

#define IOCTL_TEST_002 \
    CTL_CODE( SIOCTL_TYPE, 0x905, METHOD_NEITHER , FILE_ANY_ACCESS  )

#define IOCTL_TEST_003 \
    CTL_CODE( SIOCTL_TYPE, 0x906, METHOD_NEITHER , FILE_ANY_ACCESS  )

#define IOCTL_TEST_004 \
    CTL_CODE( SIOCTL_TYPE, 0x907, METHOD_NEITHER , FILE_ANY_ACCESS  )
#define IOCTL_TEST_005 \
    CTL_CODE( SIOCTL_TYPE, 0x908, METHOD_NEITHER , FILE_ANY_ACCESS  )
#define IOCTL_TEST_006 \
